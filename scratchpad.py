...
def padding_oracle_test(token_hex: str):
    from binascii import unhexlify
    token = unhexlify(token_hex)
    valid, message = seer.fortune_from_token(token)
    if message.startswith("Your token is not from me"):
        return False  # Bad padding
    return True  # Padding is valid (even if JSON or flag is wrong)

print(padding_oracle_test("7e0f7918587bb251e2828369a08bedeac9da3ecd363b43ad076442826e557b38bea3aaf569f8c90a750d24fee88c90b61f03211e338715606db246e8801cfd8b1cc97766ef779981f3e253c483af6ab32a472bc15d8c3a6b8ca39cb3c322043a3d572b3930e366291a8c4af673263d9d"))
